...
import { getDocs, getFirestore, collection, onSnapshot, doc, addDoc } from "firebase/firestore";
...
async function addSurvey(db, payload) {
  const docRef = await addDoc(collection(db, "surveys"), payload);
  console.log("Document written with ID: ", docRef.id);
}

export {getSurveys, snapShotSurveys, addSurvey}